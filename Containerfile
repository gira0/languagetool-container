ARG LT_VER=6.4
FROM registry.access.redhat.com/ubi10/ubi:10.2 as stage1
ARG LT_VER
...
FROM registry.access.redhat.com/ubi10/ubi:10.2 as stage2
ARG LT_VER
